...
| invariants | PASS | - |
| malformed | PASS | - |
| repetition | FAIL | fatals=trip_bigram_content:3 ; warns=trip_bigram_function_only:1, trip_token_function_only:56 |
| leakage | PASS | - |
| duplication | PASS | - |
| proportions | PASS | n=197, notes=mode_tone_proportion PASS language=en n=197 | lane03_optional_shares PASS language=en n=197 tool_call_share=0.000/0.100 image_context_share=0.000/0.050 | lane03_reasoning_structure_distribution PASS language=en n=197 implicit_multistep_share=1.000 top_structure_share=0.036 |
| viability | PASS | notes=not_applicable |
| warn_only | WARN | warns=trip_bigram_function_only:1, trip_token_function_only:56 ; notes=aggregated_non_blocking_warnings |
...
| --- | --- | --- | --- | --- | --- | --- |
| `trip_bigram_content` | FATAL | repetition | 3 | yes | Repetition gate hit; inspect repeated token/bigram in assistant_response. | assistant_response has content bigram 'a risk' repeated 3x in 30-token window |
| `trip_token_function_only` | WARN | repetition, warn_only | 56 | no | Repetition gate hit; inspect repeated token/bigram in assistant_response. | assistant_response has function token 'the' repeated 3x in 12-token window |
...
- `lane_03_think_mode_en_00000072`: assistant_response has content bigram 'a risk' repeated 3x in 30-token window
- `lane_03_think_mode_en_00000073`: assistant_response has content bigram 'a qa' repeated 3x in 30-token window
