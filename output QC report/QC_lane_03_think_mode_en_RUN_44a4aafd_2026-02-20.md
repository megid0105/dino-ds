...
| Gate | Status | Notes |
| --- | --- | --- |
| invariants | FAIL | fatals=unknown_field_forbidden:_lane:200 |
| malformed | PASS | - |
| repetition | PASS | - |
| leakage | PASS | - |
| duplication | PASS | - |
...
- `unknown_field_forbidden:_lane`: 200
...
| --- | --- | --- | --- | --- | --- | --- |
| `unknown_field_forbidden:_lane` | FATAL | invariants | 200 | yes | Remove non-schema fields from row payload. | unknown_field_forbidden:_lane |

## Top Examples
Examples are short and only include assistant/tool_call context to avoid leaking raw prompts.
### `unknown_field_forbidden:_lane`
- `lane_03_think_mode_en_00000000`: unknown_field_forbidden:_lane
- `lane_03_think_mode_en_00000001`: unknown_field_forbidden:_lane
- `lane_03_think_mode_en_00000002`: unknown_field_forbidden:_lane
- `lane_03_think_mode_en_00000003`: unknown_field_forbidden:_lane
- `lane_03_think_mode_en_00000004`: unknown_field_forbidden:_lane
